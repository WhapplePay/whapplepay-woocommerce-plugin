=== WhapplePay Integrator for WooCommerce ===
...
Integrate WhapplePay gateway with WooCommerce for secure payments and enhanced customer trust.

== Description ==

The WhapplePay Integrator for WooCommerce plugin enables you to seamlessly integrate the WhapplePay payment gateway with your WooCommerce-powered website. Accept payments securely and enhance customer trust with this easy-to-use plugin.

== Installation ==

1. Upload the `whapplepay-woocommerce-plugin` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to WooCommerce > Settings > Payments to configure WhapplePay settings
4. Enable the WhapplePay payment gateway and enter your WhapplePay client ID and client secret
5. Configure additional settings as needed
6. Save changes and start accepting payments through WhapplePay!

== Frequently Asked Questions ==

### How do I get my WhapplePay client ID and client secret?

You can obtain your WhapplePay client ID and client secret by signing up for a WhapplePay account and accessing your dashboard. Follow the instructions provided by WhapplePay to generate and retrieve your API credentials.

### Is this plugin compatible with the latest version of WooCommerce?

Yes, this plugin is compatible with WooCommerce version [insert version here].
